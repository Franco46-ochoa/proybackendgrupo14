...
Usuario.hasMany(Zona, { foreignKey: "empresaId", as: "zonasPropias" });
Zona.belongsTo(Usuario, { foreignKey: "empresaId", as: "dueño" });
...
Usuario.hasMany(CodigoInvitacion, { foreignKey: "empresaId", as: "codigos" });
CodigoInvitacion.belongsTo(Usuario, { foreignKey: "empresaId", as: "dueno" });

// ─── Sucursal → CodigoInvitacion (1:N) ───
Sucursal.hasMany(CodigoInvitacion, { foreignKey: "sucursalId", as: "codigos" });
CodigoInvitacion.belongsTo(Sucursal, {
  foreignKey: "sucursalId",
  as: "sucursal",
});
